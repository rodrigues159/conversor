...
const request =
    'https://api.hgbrasil.com/finance?format=json-cors&key=20ba17d4';
...
class _HomeState extends State<Home> {
  ...
  void _dolarChanged(String text) {
    ...
    euroController.text = (dolar * this.dolar / euro).toStringAsFixed(2).replaceAll(".", ",");
  }
  ...
  void _euroChanged(String text) {
    ...
    dolarController.text = (euro * this.euro / dolar).toStringAsFixed(2).replaceAll(".", ",");
  }
